...
Note: If you uncheck it, the position were you pointing at becomes origin,
...
Note: Assembling the track relative to the first piece will be snapped also, because
