...
DSC["trackasmlibMakePiece(svansnnnn)"] = "Creates new track piece with position angle, mass, body-group code and color by model"
...
DSC["trackasmlibSnapNormal(vasnvv)"] = "Snaps a track on the trace surface with position, angle, model, point ID, position offset and angle offset"
