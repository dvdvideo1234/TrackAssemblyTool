...
if(CLIENT) then -- con >> control, def >> deafault, hd >> header, lb >> label
  ...
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".engunsnap"     , "Contrôle l'alignement quand la pièce est tombée par le pistolet physique d'un joueur")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".engunsnap_con" , "Activer l'alignement par pistolet physique")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_export"     , "Cliquer pour exporter la base de données client dans un fichier")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_export_lb"  , "Exporter")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_routine"    , "La liste de vos pièces de pistes utilisés fréquemment")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_routine_hd" , "Pièces fréquents par: ")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_display"    , "Le modèle de votre pièce de piste est affiché ici")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_pattern"    , "Entrer un modèle ici et appuyer sur entrée pour effectuer une recherche")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_srchcol"    , "Choisir la liste de colonne auquel vous voulez effectuer une recherche sur")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_srchcol_lb" , "<Recherche>")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_srchcol_lb1", "Modèle")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_srchcol_lb2", "Type")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_srchcol_lb3", "Nom")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_srchcol_lb4", "Fin")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_routine_lb" , "Articles de routine")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_routine_lb1", "Utilisé")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_routine_lb2", "Fin")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_routine_lb3", "Type")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_routine_lb4", "Modèle")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_display_lb" , "Affichage pièce")
  asmlib.SetLocalify("FRA","tool."..gsToolNameL..".pn_pattern_lb" , "Entrer Modèle")
