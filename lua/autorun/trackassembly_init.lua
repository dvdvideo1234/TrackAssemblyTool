...
asmlib.SetOpVar("TOOL_VERSION","9.878")
...
asmlib.NewTable("PIECES",{
  ...
  Cache = {
    ...
    Record = function(makTab, tCache, snPK, arLine)
      ...
      if(not asmlib.IsHere(stData.Type)) then stData.Type = asmlib.GetTypeNormalize(arLine[2]) end
    ...
    ExportTypeRUN = function(sType, makP, PCache, qPieces)
      ...
      local sType = asmlib.GetTypeNormalize(sType)
