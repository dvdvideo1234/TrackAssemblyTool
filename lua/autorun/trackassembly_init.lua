...
asmlib.SetOpVar("TOOL_VERSION","5.280")
...
if(CLIENT) then --- con >> control, def >> deafault
  ...
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".phytype_def"  , "<Избери тип на повърността>")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".phyname"      , "Изберете името на фзическите свойсва което да се използва при създаване на трасе като това ще повлияе на повърхностното триене")
  ...
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".count"        , "Максимален брой парчета които може да се създададат при натрупване")
  ...
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".nextx"        , "Допълнително отместване на началото по X")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".nextx_con"    , "Отместване по X:")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".nexty"        , "Допълнително отместване на началото по Y")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".nexty_con"    , "Отместване по Y:")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".nextz"        , "Допълнително отместване на началото по Z")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".nextz_con"    , "Отместване по Z:")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".gravity"      , "Управлява гравитацята върху създаденото парче")
  ...
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".freeze"       , "Суздава парчето в замразено състояние")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".freeze_con"   , "Замрази при създаване")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".igntype"      , "Пренебрегва различните топове парчета при on лепене/натруване")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".igntype_con"  , "Пренебрегни типа на парчето")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".spnflat"      , "Следващото парче ще бъде създадено/залепено/натрупано хоризонатално")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".spnflat_con"  , "Създай хоризонатално")
  asmlib.SetLocalify("BUL","tool."..gsToolNameL..".mcspawn"      , "Създава парчето в масовия център, иначе спямо избраната активна точка")
