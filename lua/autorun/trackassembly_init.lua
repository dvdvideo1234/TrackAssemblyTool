...
if(file.Exists(gsFullDSV.."PIECES.txt", "DATA")) then
  ...
  asmlib.InsertRecord({"models/props_phx/trains/tracks/track_225_down.mdl", "#", "#", 2, "", "4.0960001945496,-0.0070000002160668,48.791000366211", "@22.5,0,0"})
  ...
  asmlib.InsertRecord({"models/props_phx/trains/tracks/track_225_up.mdl", "#", "#", 2, "", "4.1960000991821,0,27.054000854492", "@-22.5,0,0"})
  ...
  asmlib.DefaultType("PHX Tubes Miscellaneous")
  --- Tubes Metal ---
