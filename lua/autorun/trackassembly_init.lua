...
asmlib.SetOpVar("TOOL_VERSION","7.582")
...
if(fileExists(gsFullDSV.."PIECES.txt", "DATA")) then
  ...
  PIECES:Record({"models/roads_pack/single_lane/0-7_single_lane_x128.mdl", "#", "#", 1, "", "0,0,3.03125", "", ""})
  PIECES:Record({"models/roads_pack/single_lane/0-7_single_lane_x128.mdl", "#", "#", 2, "", "-9216,0,3.03125", "0,-180,0", ""})
  ...
  PIECES:Record({"models/buildingspack2/emptylots/0-5_empty_lot_x8x4.mdl", "#", "#", 1, "", "-268, 288,3.03125", "0, 90,0", ""})
  PIECES:Record({"models/buildingspack2/emptylots/0-5_empty_lot_x8x4.mdl", "#", "#", 2, "", "-268,-288,3.03125", "0,-90,0", ""})
