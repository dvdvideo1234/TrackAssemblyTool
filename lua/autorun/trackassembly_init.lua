...
if(fileExists(gsFullDSV.."PIECES.txt", "DATA")) then
  ...
  PIECES:Record({"models/props_phx/trains/tracks/track_x.mdl", "#", "Cross 45", 1, "", "250.47439,49.61328,11.214844"})
  PIECES:Record({"models/props_phx/trains/tracks/track_x.mdl", "#", "Cross 45", 2, "", "-261.62405,261.73975,11.214844", "0,135,0"})
  PIECES:Record({"models/props_phx/trains/tracks/track_x.mdl", "#", "Cross 45", 3, "", "-349.48406,49.61377,11.214844", "0,180,0"})
