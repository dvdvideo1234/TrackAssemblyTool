...
asmlib.SetOpVar("TOOL_VERSION","5.380")
...
if(CLIENT) then -- con >> control, def >> deafault, hd >> header, lb >> label
  ...
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".bgskids"       , "Код выбора через запятую для Bodygroup/Skin ID > ENTER чтобы принять ТАБ для автоматического заполнения из трассировки")
  ...
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_pattern"    , "Введите шаблон здесь и нажмите ВВОД для выполнения поиска")
