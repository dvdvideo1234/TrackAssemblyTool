...
if(SERVER) then
  ...
  asmlib.MakeCoVar("sbox_max"..GetOpVar("CVAR_LIMITNAME"),"2000",nil,bitBor(FCVAR_ARCHIVE, FCVAR_ARCHIVE_XBOX, FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_PRINTABLEONLY), "Maximum pieces to be spawned")
end
...
if(fileExists(gsFullDSV.."PIECES.txt", "DATA")) then
  ...
  asmlib.InsertRecord({"models/ron/2ft/straight/straight_32_2tracks.mdl", "#", "#", 1, "", " 16,-62,6.016", "0,0,0"})
  asmlib.InsertRecord({"models/ron/2ft/straight/straight_32_2tracks.mdl", "#", "#", 2, "", " 16, 62,6.016", "0,0,0"})
