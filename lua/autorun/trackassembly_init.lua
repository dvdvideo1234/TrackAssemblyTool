...
asmlib.SetOpVar("TOOL_VERSION","5.147")
...
asmlib.SetOpVar("LOG_SKIP",{"Qsort","ModelToName","ArrayCount","GetNormalSpawn: Not hitting active point"})
...
if(file.Exists(gsFullDSV.."PIECES.txt", "DATA")) then
  ...
  asmlib.SettingsModelToName("SET",nil,{"m_gauge_","straight "},nil)
