...
asmlib.SetOpVar("TOOL_VERSION","5.345")
...
if(CLIENT) then -- con >> control, def >> deafault, hd >> header, lb >> label
  ...
  -- Russain
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".1"             , "Создает объект сегментирован трек")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".left"          , "Порождать/Защелкивать кусок. Удерживайте СДВИГ чтобы нагромождать")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".right"         , "Изменить точки сборку. Удерживайте СДВИГ чтобы реверс (Быстро: АЛТ + ПРОКРУТКИ)")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".right_use"     , "Открыть меню часто используемых кусков")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".reload"        , "Убрать кусок. Удерживайте СДВИГ чтобы выбрать якорь")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".desc"          , "Создает трек для транспортных средств")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".name"          , "Сборку трека")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".phytype"       , "Выбрать типа физические свойства от тех которые перечислены здесь")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".phytype_def"   , "<Выберите ТИП поверхности>")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".phyname"       , "Выберите имя физическое свойства для использования при создании трека, как это повлияет на поверхностное трение")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".phyname_def"   , "<Выберите ИМЯ поверхности>")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".bgskids"       , "Код выбора через запятую для Bodygroup/Skin ID > ENTER чтобы принять TAB для автоматического заполнения от трейса")
  ...
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".mass_con"      , "Кусок масса:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".model"         , "Выберите кусок модель для использования")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".model_con"     , "Выберите кусок, чтобы начать/продолжить свой трек с помощью расширения типа и нажав на узле")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".activrad"      , "Минимальное расстояние необходимо чтобы выбрать активную точку")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".activrad_con"  , "Активный радиус:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".count"         , "Максимальное количество куски нагромождать")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".count_con"     , "Количество кусочки:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".ydegsnp"       , "Защелкивать первый кусок на это много градусов")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".ydegsnp_con"   , "Рыскания защелкивать количество:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".resetvars"     , "Нажмите чтобы сбросить дополнительные значения")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".resetvars_con" , "V Сбросить переменными V")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextpic"       , "Дополнительное угловое смещение тангажа происхождении")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextpic_con"   , "Происхождении тангажа:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextyaw"       , "Дополнительное угловое смещение рыскания происхождении")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextyaw_con"   , "Происхождении рыскания:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextrol"       , "Дополнительное угловое смещение рулона происхождении")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextrol_con"   , "Происхождении рулон:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextx"         , "Дополнительное линейное смещение X происхождении")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextx_con"     , "Смещения X:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nexty"         , "Дополнительное линейное смещение Y происхождении")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nexty_con"     , "Смещения Y:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextz"         , "Дополнительное линейное смещение Z происхождении")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nextz_con"     , "Смещения Z:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".gravity"       , "Управляет гравитацию на куске создал")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".gravity_con"   , "Применить кусок гравитацию")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".weld"          , "Создает сварные швы между куски или кусок/якорь")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".weld_con"      , "Сварной шов")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".forcelim"      , "Управляют сколько сил требуется чтобы сломать сварной шов")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".forcelim_con"  , "Ограничение сил:")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".ignphysgn"     , "Игнорирует пушки физике захватить на кусок создал/защелкал/нагромождал")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".ignphysgn_con" , "Игнорировать пушки физике")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nocollide"     , "Делает нет-коллизия между кусками or куски/якорь")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".nocollide_con" , "Нет-коллизия")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".freeze"        , "Делает кусок создаюсь в замороженном состоянии")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".freeze_con"    , "Заморожи на создание")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".igntype"       , "Делает инструмент игнорировать различные типы на кусок создал/нагромождал")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".igntype_con"   , "Игнорировать тип кусками")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".spnflat"       , "Следующий кусок будет порождал/защелкал/нагромождал горизонтально")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".spnflat_con"   , "Нагромождать горизонтально")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".mcspawn"       , "Создает кусок в центра массы, еще по отношению к выбранной активной точку")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".mcspawn_con"   , "Происхождении в центра массы")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".surfsnap"      , "Защелкал кусок к поверхности игрок указывал")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".surfsnap_con"  , "Защелки по поверхности трейса")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".adviser"       , "Управлять инструментом визуализации позиционный/угловой советника")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".adviser_con"   , "Нарисовать советника")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pntasist"      , "Управлять инструментом визуализации помощника точку")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pntasist_con"  , "Нарисовать помощника")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".ghosthold"     , "Управлять визуализации инструмента держатель кусок призраки")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".ghosthold_con" , "Нарисовать кусок призраки")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".engunsnap"     , "Управлять щелкать когда кусок отбрасывается от пушки физике игрока")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".engunsnap_con" , "Включить пушки физике щелкать")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_export"     , "Нажмите чтобы экспортировать базу данных клиента в виде файла")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_export_lb"  , "Экспорт БД")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_routine"    , "Список часто используемых куски трека")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_routine_hd" , "Часто используемых кусков от: ")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_display"    , "Модель вашего трека кусок здесь отображается")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_pattern"    , "Введите шаблон здесь и нажмите клавишу ВВОД чтобы выполнить поиск")
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_srchcol"    , "Выберите на котором список столбцов вы хотите чтобы выполнить поиск")
  ...
  asmlib.SetLocalify("ru","tool."..gsToolNameL..".pn_routine_lb" , "Рутинное предметов")
  ...
  asmlib.SetLocalify("ru","Cleaned_"..gsLimitName                , "Почищены все куски трека")
  asmlib.SetLocalify("ru","SBoxLimit_"..gsLimitName              , "Вы попали в лимит создает треков!")
end
