...
asmlib.SetOpVar("TOOL_VERSION","4.40")
...
if(file.Exists(gsFullDSV.."PIECES.txt", "DATA")) then
  ...
  asmlib.GsubModelToName({"diagonal_","ramp_"})
  ...
  asmlib.GsubModelToName({"track_","straight_"})
  ...
  asmlib.GsubModelToName({"turn","turn_"})
  ...
  asmlib.GsubModelToName({"track_s","straight_"})
  asmlib.GappModelToName({"","x"})
  ...
  asmlib.GsubModelToName({"track_t","turn_","02","big","01","small"})
  ...
  asmlib.InsertRecord({"models/xqm/coastertrack/turn_45_2.mdl", "#", "#", 1, "", "145.801, -28.557, 4.893", "0,0,0"})
  ...
  asmlib.InsertRecord({"models/xqm/coastertrack/special_half_corkscrew_right_1.mdl", "#", "#", 1, "", "150.199, 0.013, 4.886", "0,0,0"})
  ...
  asmlib.InsertRecord({"models/xqm/coastertrack/special_half_corkscrew_left_3.mdl", "#", "#", 1, "", "449.801, -0.014, 4.882", "0,0,0"})
  ...
  asmlib.GsubModelToName({"rail_","straight_"})
  ...
  asmlib.GsubModelToName({"_crossing","","rail_","crossing_"})
  ...
  --- Shinji85 Switch ---
  asmlib.GsubModelToName({"r_","right_","l_","left_"})
  ...
  asmlib.GcutModelToName({})
  asmlib.GsubModelToName({"bridge","bridge_","001",""})
  ...
  asmlib.GsubModelToName({"bridge01_","bridge_"})
  ...
  asmlib.GcutModelToName({})
  asmlib.GsubModelToName({"lot","lot_"})
  ...
  asmlib.GcutModelToName({1,3})
  asmlib.GsubModelToName({"sdwhwy","_"})
  ...
  asmlib.GsubModelToName({"sdwhwy","_","bridge","bridge_"})
  ...
  asmlib.GcutModelToName({1,3})
  asmlib.GsubModelToName({"sdwhwy_","_","turn1","turn"})
  ...
  asmlib.GcutModelToName({1,4})
  asmlib.GsubModelToName({"sdw","_","walk","walk_"})
  ...
  asmlib.GcutModelToName({1,3})
  asmlib.GsubModelToName({"sdwhwy_","_"})
  ...
  asmlib.GsubModelToName({"m_gauge_","Straight "})
  ...
  asmlib.GsubModelToName({"_cross","","m_gauge_","cross_"})
  ...
  asmlib.GsubModelToName({"m_gauge_",""})
  ...
  asmlib.GsubModelToName({"m_gauge_","","over",""})
  ...
  asmlib.GsubModelToName({"m_gauge_","","hand",""})
