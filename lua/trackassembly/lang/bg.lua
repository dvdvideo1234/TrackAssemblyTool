return function(sTool, sLimit) local tSet = {} -- Bulgarian
  ...
  tSet["tool."..sTool..".timermode_ap"     ] = "Кликнете за да приложите избраните настойки върху мениджъра на паметта"
  ...
  tSet["tool."..sTool..".logfile_con"      ] = "Включи лог файл"
  ...
  tSet["tool."..sTool..".client_var"       ] = "Клиентски предпочита на ирача. Променливи създадени чрез инструментна конфигурация"
  tSet["tool."..sTool..".nonrep_var"       ] = "Контроли за не-репликирани променливи. Приемат различни стойности на сървара и клиента"
  tSet["tool."..sTool..".relica_var"       ] = "Контроли за репликирани променливи. Сървара изпраща базова стойнот до всички клиенти"
