return {  -- French
  ...
  ["tool."..gsToolNameL..".stackcnt"      ] = "Nombre maximum de pieces a creer pendant l'empilement",
  ["tool."..gsToolNameL..".stackcnt_con"  ] = "Nombre de pieces:",
  ...
  ["tool."..gsToolNameL..".ghostcnt"      ] = "Montrer un apercu de la pièces compter active",
  ["tool."..gsToolNameL..".ghostcnt_con"  ] = "Activer compter l'aperçu de l'outil",
