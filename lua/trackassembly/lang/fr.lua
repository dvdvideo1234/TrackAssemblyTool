return function(sTool, sLimit) local tSet = {} -- French
  ...
  tSet["tool."..sTool..".pn_externdb"   ] = "Les base de donnees disponibles pour:"
  tSet["tool."..sTool..".pn_externdb_hd"] = "Base de donnees de:"
  tSet["tool."..sTool..".pn_externdb_lb"] = "Clic droit pour les options:"
  tSet["tool."..sTool..".pn_externdb_1" ] = "Copier prefixe unique"
  tSet["tool."..sTool..".pn_externdb_2" ] = "Copier dossier DSV"
  tSet["tool."..sTool..".pn_externdb_3" ] = "Copier nom table"
  ...
  tSet["tool."..sTool..".pn_externdb_7" ] = "Modifier les elements (Luapad)"
  tSet["tool."..sTool..".pn_externdb_8" ] = "Supprimer l'entree de la base de donnee"
  tSet["tool."..sTool..".pn_ext_dsv_lb" ] = "Liste DSV externe"
  tSet["tool."..sTool..".pn_ext_dsv_hd" ] = "La liste des base de donnees DSV sont affichees ici"
  tSet["tool."..sTool..".pn_ext_dsv_1"  ] = "Prefixe unique de la base de donnee"
